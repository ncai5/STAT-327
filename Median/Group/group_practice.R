...
for (i in 1:2){
  ...
  page_link = # figure out how to set each main-page link here
  
  lines = readLines(page_link); 
  ...
  including_links = # using pattern/regular expression
  
  # ... using pattern/regular expression
    
  game_links = # all game links from cuurent page i
